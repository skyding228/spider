...
(function ($) {
    function init(target, options) {
        ...
        var maskm = $('<div class="mask-msg"></div>').html(options.maskHtml || options.maskMsg).appendTo(wrap).css(maskMsgCss);
    ...
    $.fn.mask.methods = {
        hide: function (jq) {
            return jq.each(function () {
                var wrap = $(this);
                $("div.mask", wrap).fadeOut('slow', function () {
                    $(this).remove();
                });
    ...
    $.fn.mask.defaults = {
        maskMsg: '请稍候...',
        maskHtml: '<img src="/static/imgs/loading.gif"/>',
        zIndex: 1000,
        timeout: 30000,
        opacity: 0.5
    };
